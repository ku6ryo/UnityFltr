...
public sealed partial class FaceDetector : System.IDisposable
{
    ...
    public FaceDetector()
    {
        ...
        nnModel = (NNModel) Resources.Load("FaceDetector/face_detection_back_256x256_barracuda");
        preprocessShader = (ComputeShader) Resources.Load("FaceDetector/Shaders/Preprocess");
        postProcessShader1 = (ComputeShader) Resources.Load("FaceDetector/Shaders/PostProcess1");
        postProcessShader2 = (ComputeShader) Resources.Load("FaceDetector/Shaders/PostProcess2");
        AllocateObjects();
    }
    ...
    ComputeShader postProcessShader1;
    ComputeShader postProcessShader2;
